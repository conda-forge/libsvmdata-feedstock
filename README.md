...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/libsvmdata-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15629&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/libsvmdata-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `libsvmdata` can be installed with:

```
conda install libsvmdata
```

It is possible to list all of the versions of `libsvmdata` available on your platform with:
